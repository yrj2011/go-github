...
func TestRepositoriesService_CompareCommits(t *testing.T) {
	...
	mux.HandleFunc("/repos/o/r/compare/b...h", func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprintf(w, `{
		  ...
		  "files": [ { "filename": "f" } ],
		  "html_url":      "http://github.com/o/r/compare/b...h",
		  "permalink_url": "http://github.com/o/r/compare/o:bbcd538c8e72b8c175046e27cc8f907076331401...o:0328041d1152db8ae77652d1618a02e57f745f17",
		  "diff_url":      "http://github.com/o/r/compare/b...h.diff",
		  "patch_url":     "http://github.com/o/r/compare/b...h.patch",
		  "url":           "http://api.github.com/repos/o/r/compare/b...h"
		}`)
	})
	...
	want := &CommitsComparison{
		...
		HTMLURL:      String("http://github.com/o/r/compare/b...h"),
		PermalinkURL: String("http://github.com/o/r/compare/o:bbcd538c8e72b8c175046e27cc8f907076331401...o:0328041d1152db8ae77652d1618a02e57f745f17"),
		DiffURL:      String("http://github.com/o/r/compare/b...h.diff"),
		PatchURL:     String("http://github.com/o/r/compare/b...h.patch"),
		URL:          String("http://api.github.com/repos/o/r/compare/b...h"),
	}
